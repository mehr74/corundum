...
kugelblitz_offload_inst (
        ...
        .kg_qsfp0_tx_clk(qsfp0_tx_clk),
        .kg_qsfp0_tx_rst(qsfp0_tx_rst),
        .kg_qsfp0_rx_clk(qsfp0_rx_clk),
        .kg_qsfp0_rx_rst(qsfp0_rx_rst),
        .kg_qsfp1_tx_clk(qsfp1_tx_clk),
        .kg_qsfp1_tx_rst(qsfp1_tx_rst),
        .kg_qsfp1_rx_clk(qsfp1_rx_clk),
        .kg_qsfp1_rx_rst(qsfp1_rx_rst),

        // tx from cmac_pad (originally from fpga core)
        .kg_qsfp0_tx_s_axis_tdata(qsfp0_tx_s_axis_tdata),
        .kg_qsfp0_tx_s_axis_tkeep(qsfp0_tx_s_axis_tkeep),
        .kg_qsfp0_tx_s_axis_tvalid(qsfp0_tx_s_axis_tvalid),
        .kg_qsfp0_tx_s_axis_tready(qsfp0_tx_s_axis_tready),
        .kg_qsfp0_tx_s_axis_tlast(qsfp0_tx_s_axis_tlast),
        .kg_qsfp0_tx_s_axis_tuser(qsfp0_tx_s_axis_tuser),

        // rx to fpga core
        .kg_qsfp0_rx_m_axis_tdata(qsfp0_rx_m_axis_tdata),
        .kg_qsfp0_rx_m_axis_tkeep(qsfp0_rx_m_axis_tkeep),
        .kg_qsfp0_rx_m_axis_tvalid(qsfp0_rx_m_axis_tvalid),
        .kg_qsfp0_rx_m_axis_tlast(qsfp0_rx_m_axis_tlast),
        .kg_qsfp0_rx_m_axis_tuser(qsfp0_rx_m_axis_tuser),

        // tx to cmac
        .kg_qsfp0_tx_m_axis_tdata(qsfp0_tx_m_axis_tdata),
        .kg_qsfp0_tx_m_axis_tkeep(qsfp0_tx_m_axis_tkeep),
        .kg_qsfp0_tx_m_axis_tvalid(qsfp0_tx_m_axis_tvalid),
        .kg_qsfp0_tx_m_axis_tready(qsfp0_tx_m_axis_tready),
        .kg_qsfp0_tx_m_axis_tlast(qsfp0_tx_m_axis_tlast),
        .kg_qsfp0_tx_m_axis_tuser(qsfp0_tx_m_axis_tuser),

        // rx from cmac
        .kg_qsfp0_rx_s_axis_tdata(qsfp0_rx_s_axis_tdata),
        .kg_qsfp0_rx_s_axis_tkeep(qsfp0_rx_s_axis_tkeep),
        .kg_qsfp0_rx_s_axis_tvalid(qsfp0_rx_s_axis_tvalid),
        .kg_qsfp0_rx_s_axis_tlast(qsfp0_rx_s_axis_tlast),
        .kg_qsfp0_rx_s_axis_tuser(qsfp0_rx_s_axis_tuser),

        // tx from cmac_pad (originally from fpga_core)
        .kg_qsfp1_tx_s_axis_tdata(qsfp1_tx_s_axis_tdata),
        .kg_qsfp1_tx_s_axis_tkeep(qsfp1_tx_s_axis_tkeep),
        .kg_qsfp1_tx_s_axis_tvalid(qsfp1_tx_s_axis_tvalid),
        .kg_qsfp1_tx_s_axis_tready(qsfp1_tx_s_axis_tready),
        .kg_qsfp1_tx_s_axis_tlast(qsfp1_tx_s_axis_tlast),
        .kg_qsfp1_tx_s_axis_tuser(qsfp1_tx_s_axis_tuser),

        // rx to fpga_core
        .kg_qsfp1_rx_m_axis_tdata(qsfp1_rx_m_axis_tdata),
        .kg_qsfp1_rx_m_axis_tkeep(qsfp1_rx_m_axis_tkeep),
        .kg_qsfp1_rx_m_axis_tvalid(qsfp1_rx_m_axis_tvalid),
        .kg_qsfp1_rx_m_axis_tlast(qsfp1_rx_m_axis_tlast),
        .kg_qsfp1_rx_m_axis_tuser(qsfp1_rx_m_axis_tuser),

        // tx to cmac
        .kg_qsfp1_tx_m_axis_tdata(qsfp1_tx_m_axis_tdata),
        .kg_qsfp1_tx_m_axis_tkeep(qsfp1_tx_m_axis_tkeep),
        .kg_qsfp1_tx_m_axis_tvalid(qsfp1_tx_m_axis_tvalid),
        .kg_qsfp1_tx_m_axis_tready(qsfp1_tx_m_axis_tready),
        .kg_qsfp1_tx_m_axis_tlast(qsfp1_tx_m_axis_tlast),
        .kg_qsfp1_tx_m_axis_tuser(qsfp1_tx_m_axis_tuser),

        // rx from cmac
        .kg_qsfp1_rx_s_axis_tdata(qsfp1_rx_s_axis_tdata),
        .kg_qsfp1_rx_s_axis_tkeep(qsfp1_rx_s_axis_tkeep),
        .kg_qsfp1_rx_s_axis_tvalid(qsfp1_rx_s_axis_tvalid),
        .kg_qsfp1_rx_s_axis_tlast(qsfp1_rx_s_axis_tlast),
        .kg_qsfp1_rx_s_axis_tuser(qsfp1_rx_s_axis_tuser),
